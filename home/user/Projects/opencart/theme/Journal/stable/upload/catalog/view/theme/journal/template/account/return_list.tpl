...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="return-list">
    ...
    <div class="return-content">
      ...
      <div class="return-info"><a href="<?php echo $return['href']; ?>"><img src="catalog/view/theme/journal/images/info.png" alt="<?php echo $button_view; ?>" title="<?php echo $button_view; ?>" /></a></div>
    </div>
  </div>
  <?php } ?>
