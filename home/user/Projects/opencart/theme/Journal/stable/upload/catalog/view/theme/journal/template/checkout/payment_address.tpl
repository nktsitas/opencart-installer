...
<div id="payment-existing">
  <select name="address_id" style=" margin-bottom: 15px;" size="5">
...
$('#payment-address select[name=\'country_id\']').bind('change', function() {
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#payment-address select[name=\'country_id\']').after('<span class="wait">&nbsp;<img src="catalog/view/theme/journal/images/loading.gif" alt="" /></span>');
		},
		complete: function() {
			$('.wait').remove();
		},			
