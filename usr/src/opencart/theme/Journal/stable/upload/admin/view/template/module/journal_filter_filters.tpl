    ...
    <div class="content">
      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          <thead>
            <tr>
              <td width="1" class="left" style="text-align: center;">
                Delete
                <!-- <input type="checkbox" onclick="$('input[name*=\'selected\']').attr('checked', this.checked);" /> -->
              </td>
              <td class="left" style="font-weight: bold; font-size: 13px "><?php echo $column_category; ?> </td>
          ...
          <tbody>
            ...
            <tr>
              <td class="left" style="text-align: center;">
                <input class="check" type="checkbox" name="selected[]" value="<?php echo $filter['id']; ?>" />
              </td>
              <td class="left" style="font-weight: bold; font-size: 13px "><?php echo $filter['name']; ?></td>
              <td class="right">
                 <a class="btn" href="<?php echo $action . '&filter_id=' . $filter['id']; ?>"><?php echo $button_edit; ?></a> 
              </td>
            </tr>
            <?php } ?>
            <?php } else { ?>
