...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="order-list">
    ...
    <div class="order-content">
      ...
      <div class="order-info"><a href="<?php echo $order['href']; ?>"><img src="catalog/view/theme/journal/images/info.png" alt="<?php echo $button_view; ?>" title="<?php echo $button_view; ?>" /></a>&nbsp;&nbsp;<a href="<?php echo $order['reorder']; ?>"><img src="catalog/view/theme/journal/images/reorder.png" alt="<?php echo $button_reorder; ?>" title="<?php echo $button_reorder; ?>" /></a></div>
    </div>
  </div>
  <?php } ?>
