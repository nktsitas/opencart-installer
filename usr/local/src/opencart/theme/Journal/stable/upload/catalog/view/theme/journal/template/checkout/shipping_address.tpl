...
<div id="shipping-existing">
  <select name="address_id" style="width: margin-bottom: 15px;" size="5">
...
$('#shipping-address select[name=\'country_id\']').bind('change', function() {
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#shipping-address select[name=\'country_id\']').after('<span class="wait">&nbsp;<img src="catalog/view/theme/journal/images/loading.gif" alt="" /></span>');
		},
		complete: function() {
			$('.wait').remove();
		},			
