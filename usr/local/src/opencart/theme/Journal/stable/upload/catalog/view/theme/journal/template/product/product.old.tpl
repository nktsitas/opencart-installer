...
<script type="text/javascript">stLight.options({publisher: "c2346c4f-2838-44e0-a0df-cbbf95574ed0"});</script>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/journal/stylesheet/jquery.jqzoom.css">
<script src="catalog/view/javascript/journal/jquery.jqzoom-core-pack.js"></script>
<script>
...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-info">
    ...
    <div class="left">
      ...
      <?php if ($thumb) { ?>
      <div class="image">
        <a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class="zoom" rel="product-zoom">
      ...
      <div class="image-additional">
        ...
        <a href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>" href="javascript:void(0);" rel="{gallery: 'product-zoom', smallimage: '<?php echo $image['custom'];?>',largeimage: '<?php echo $image['popup'];?>'}">
          <img src="<?php echo $image['thumb']; ?>" title="<?php echo $heading_title; ?>" data-custom="<?php echo $image['custom'];?>" alt="<?php echo $heading_title; ?>" />
        </a>
        <?php } ?>
      </div>
      <?php } ?>
...
new AjaxUpload('#button-option-<?php echo $option['product_option_id']; ?>', {
	...
	onSubmit: function(file, extension) {
		$('#button-option-<?php echo $option['product_option_id']; ?>').after('<img src="catalog/view/theme/journal/image/loading.gif" class="loading" style="padding-left: 5px;" />');
